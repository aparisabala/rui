@extends('admin.layout.main_layout', ["tabTitle" => config('i.service_name')." | Image Editor"])
@section('page')
    <div class="row">
        <div class="col-md-12">
            <div class="card p-4">
                <h1 class="fs-30 text-center"> Image Editor V3 </h1>
                <!-- Content -->
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="docs-demo">
                                <div class="img-container">
                                    <img src="{{ url('statics/images/system/cropper/picture.jpg') }}" alt="Picture">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row" id="actions">
                        <div class="col-md-9 docs-buttons">
                            ...
                            <div class="modal fade editmodal edimodalGlob" id="getCroppedCanvasModal" tabindex="-1"
