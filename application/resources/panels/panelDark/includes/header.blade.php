...
<div class="navbar navbar-dark navbar-expand-lg navbar-static">
	<div class="container-fluid">
		...
		@endif
		<div class="navbar-brand flex-0 flex-lg-0">
			<a href="{{url('admin/dashboard')}}" class="d-inline-flex align-items-center">
				<img src="{{ url('statics/images/system/p_logo.png') }}" alt="" style="width: 160px;height: 40px;">
			</a>
		</div>
			...
			<li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
				<a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
					<div class="status-indicator-container">
						<img src="{{ $link }}" class="w-32px h-32px rounded-pill" alt="">
						<span class="status-indicator bg-success"></span>
					</div>
					<span class="d-none d-lg-inline-block mx-lg-2">{{ Auth::user()->name }}</span>
				</a>
				<div class="dropdown-menu dropdown-menu-end">
					<a href="{{ url('admin/dashboard/profile') }}" class="dropdown-item">
						<i class="ph-user-circle me-2"></i>
						My profile
					</a>
					<div class="dropdown-divider"></div>
					<a href="{{ url('admin/dashboard/password') }}" class="dropdown-item">
