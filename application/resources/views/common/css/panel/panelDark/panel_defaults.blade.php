...
<style type="text/css">
    ...
    .taxCard * {
        font-size: {{ local() == 'en' ? '14px' : '.6rem' }}
    }

    .form-control {
        font-size: {{ local() == 'en' ? '.9rem' : '.8rem' }} !important;
    }

    .dataTable th {
        font-size: {{ local() == 'en' ? '.0.75rem' : '1rem' }} !important;
    }
